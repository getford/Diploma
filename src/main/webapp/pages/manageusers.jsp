                    ...
                    <table class="table table-striped table-bordered templatemo-user-table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="exampleModal<%=userUuid%>" tabindex="-1" role="dialog"
                                     aria-labelledby="exampleModalLabel"
                                     aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Изменение
                                                    пользователя</h5>
                                            ...
                                            <form action="/change?type=<%=USER%>&uuid=<%=userUuid%>" method="post">
                                                <div class="modal-body">
                                                    ...
                                                    Логин: <input type="text" name="login" placeholder="Логин"
                                                                  value="<%=authInfoEntity.getLogin()%>">
                                                    <br/>
                                                    Email: <input type="text" name="email" placeholder="Email"
                                                                  value="<%=authInfoEntity.getEmail()%>">
                                                    <br/>
                                                    Роль: <input type="text" name="role" placeholder="Роль"
                                                                 value="<%=authInfoEntity.getRole()%>">
                                                </div>
